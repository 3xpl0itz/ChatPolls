...
public class CHPStartRewardTestPrompt extends MessagePrompt{

	private MainChatPolls plugin;
	private EachPoll currentPoll = null;
	private Player currPlayer;
	
	public CHPStartRewardTestPrompt(MainChatPolls plugin, EachPoll currentPoll, Player pl)
	{
		this.plugin = plugin;
	...
	return new CHPStartRewardProcessPrompt(plugin, currentPoll, currPlayer);
	}
