...
public class CHPStartRewardRemovePromptP2 extends MessagePrompt{
	...
	public CHPStartRewardRemovePromptP2(MainChatPolls plugin, EachPoll currentPoll, Player pl, int rewardNum)
	{
		this.plugin = plugin;
